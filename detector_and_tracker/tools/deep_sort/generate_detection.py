...
# class ImageEncoder(object):
#
#     def __init__(self, model, input_name="images",
#                  output_name="features"):
#         import pdb;pdb.set_trace()
#         self.model = model
#         for parameter in model.named_parameters():
#             print(parameter)
#         self.input_var = self.model._modules["net"].named_parameters()[f"net.{input_name}"][1]
#         self.output_var = self.model._modules["net"].named_parameters()[f"net.{output_name}"][1]
#
...
#             batch_data = data_x[i:i+batch_size]
#             input_tensor = torch.from_numpy(batch_data).permute(0, 3, 1, 2).float()
#             output_tensor = self.session.run([self.output_var], {self.input_name: input_tensor})
#             out[i:i+batch_size] = output_tensor[0]
#         return out
